          ...
          <CardContent className="p-6">
            ...
            >
              ...
              <Button
                ...
                className="brutal-border hover:bg-primary rounded-none font-bold uppercase font-mono tracking-widest text-black"
              >
          ...
          <CardContent className="p-6">
            ...
            >
              ...
              <Button
                ...
                className="brutal-border bg-destructive hover:bg-destructive/90 text-white rounded-none font-bold uppercase font-mono tracking-widest"
              >
        ...
        <Card className="brutal-border brutal-shadow rounded-none bg-black md:col-span-2">
          ...
          <CardContent className="p-6 flex justify-between items-center bg-[#0a0a0a]">
            <div className="flex flex-col gap-1">
              <span className="font-mono uppercase text-sm font-bold text-white">
                Smart Scale
              </span>
            ...
            {(scaleStatus as any)?.isLinked ? (
              <Button
                ...
                className="brutal-border bg-transparent border-red-500 text-red-500 hover:bg-red-500 hover:text-black rounded-none uppercase font-mono font-bold tracking-widest"
              >
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="brutal-border bg-primary text-black hover:bg-white rounded-none uppercase font-mono font-bold tracking-widest"
                >
